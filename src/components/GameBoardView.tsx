...
import { HORIZONTAL_CELLS_COUNT, VERTICAL_CELLS_COUNT, CELL_UNIT_SIZE } from '../redux/constants';
...
const GameBoardView: React.FC = () => {
  const { isStarted, isStopped, isFinished, hasReachedGoalLine, speedLevel, ongoingItems } = useAppSelector(selectGame);
  ...
  // when items exist and they are yet to reach the goal line.
  useEffect(() => {
